...
def create_model(env_arg):
    ...
    model_rtn.add(Dense(128, activation='sigmoid', kernel_initializer=initializers.GlorotNormal(seed=None)))
    model_rtn.add(Dense(64, activation='sigmoid', kernel_initializer=initializers.GlorotNormal(seed=None)))
    model_rtn.add(Dense(16, activation='sigmoid', kernel_initializer=initializers.GlorotNormal(seed=None)))
    model_rtn.add(Dense(1, activation='sigmoid', kernel_initializer=initializers.GlorotNormal(seed=None)))
