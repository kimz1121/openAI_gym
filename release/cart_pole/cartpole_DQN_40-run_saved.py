...
class dqn_agent():
    ...
    def save_model(self, generation, index):
        self.action_model.save("./model/CartPole-v1-omniQ/genetation-{}/action_{}.h5".format(generation, index))
        self.target_model.save("./model/CartPole-v1-omniQ/genetation-{}/target_{}.h5".format(generation, index))

    def load_model(self, generation, index):
        self.action_model = keras.models.load_model("./model/CartPole-v1-omniQ/genetation-{}/action_{}.h5".format(generation, index))
        self.target_model = keras.models.load_model("./model/CartPole-v1-omniQ/genetation-{}/action_{}.h5".format(generation, index))
